...
<head>
	...
	<title>SkyPort - Sala de Desembarque</title>
...
<body>
	...
	if(isLoadData == null){
		response.sendRedirect(Constants.ACTION_REDIRECTTO_URL + Constants.PAGE_SHOW_FLIGHTS_ARRIVING);
	}
	else{
		List<FlightData> datasource = (List<FlightData>) request.getAttribute("listTotemFlightsArriving");
	%>
		<div class = container>
